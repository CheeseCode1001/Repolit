  ...
  return (
    <div className="container max-w-screen-xl py-8 sm:py-12 flex flex-col gap-10 sm:gap-14">
      ...
      <section className="flex flex-col items-center text-center gap-5 max-w-3xl mx-auto pt-4 sm:pt-8 w-full">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-secondary text-secondary-foreground text-sm sm:text-base font-mono border border-border/60 rounded-tl-[0px] rounded-tr-[0px] rounded-br-[0px] rounded-bl-[0px]">
          <Terminal className="w-3.5 h-3.5 text-primary" />
          <span>Its free and will always be...</span>
        </div>
        ...
        <p className="text-sm sm:text-sm md:text-sm text-muted-foreground font-mono max-w-2xl leading-relaxed px-2">
        ...
        >
          ...
          >
            {createRepo.isPending ? "ONBOARDING..." : "ONBOARD ME"}
          </Button>
        </form>
        ...
        {reposLoading ? (
          ...
          <div className="text-center py-14 border border-dashed border-border/50 rounded-lg">
            ...
            <p className="text-xs text-muted-foreground/60 font-mono mt-1">
              Paste  a GitHub URL or Upload a folder above to get started.
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
